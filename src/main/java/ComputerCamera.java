...
public class ComputerCamera extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(button2);
        button2.setBounds(1110, 170, 62, 36);

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1254, Short.MAX_VALUE)
        );
    ...
    private void CaptureButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CaptureButtonActionPerformed
        ...
        int option = JOptionPane.showConfirmDialog(rootPane, "Are you sure you want to take a picture?");
        if (option == 0) {
